...
export const Skeleton: FC = () => {
  return (
    <main className="animate-pulse" aria-busy="true">
      ...
      <div className="mx-auto mt-8 grid w-full max-w-6xl gap-y-6 px-4 pb-12 md:grid-cols-[minmax(0,3fr)_minmax(0,1fr)] md:gap-x-10 md:gap-y-0 md:pb-14 lg:gap-x-12 lg:[grid-template-columns:minmax(0,5fr)_minmax(0,2fr)]">
